...
@section('content')
	...
	<div class="panel panel-default">
		<div class="panel-heading">MODIFICACIÓN DE USUARIO {{ $user->first_name.' '.$user->last_name }}</div>
		<div class="panel-body">
			...
			<div class="form-horizontal">				
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						{!! Form::select('type', ['admin'=>'Adminisrador','seller'=>'Cajero','businessman'=>'Empresario'],$user->type, ['class'=>'form-control', 'placeholder'=>'Seleccione un tipo de usuario', 'required']) !!}
					</div>
				</div>
